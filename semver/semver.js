/**
 * An semver objct 
 * @typedef {Object} Semver An object containing metadata about the version.
 * @property {number} major The major version number.
 * @property {number} minor The minor version number.
 * @property {number} patch The patch version number.
 * @property {string|null} preRelease The pre-release version identifier, if any.
 * @property {string|null} buildInfo The build metadata, if any.
 * @property {string} range The range of the version.
 */
/**
